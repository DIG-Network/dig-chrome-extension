 ...
 *  The fullscreen-only tabs (peers/advertise/tipping/security/updates) carry metadata for
 *  completeness but are not rendered in the compact bottom nav (this component maps over the
 *  compact {@link TABS} set only). */
const TAB_META: Record<Tab, { glyph: string; labelId: string }> = {
  ...
  updates: { glyph: '🔄', labelId: 'tab.updates' },
};
