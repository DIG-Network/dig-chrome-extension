...
export async function getConnection(storage) {
...
export function ok(data) { return { status: 200, body: { data } }; }
export function pending() { return { status: 202, body: {} }; }
export function err(status, message) { return { status: status || 400, body: { error: message } }; }
 ...
 */
export async function brokerRequest(deps, method, params, origin) {
  ...
  try {
    ...
    const msg = (e && e.message) || 'Wallet request failed';
    return err(502, msg);
  }
}
